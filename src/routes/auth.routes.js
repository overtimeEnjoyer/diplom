...
router.post('/email/request-code', emailOnlyRules, validate, asyncHandler(authController.requestEmailCode));
router.post('/email/verify-code', emailCodeRules, validate, asyncHandler(authController.verifyEmailCode));
router.post('/password/request-code', emailOnlyRules, validate, asyncHandler(authController.requestPasswordCode));
