...
export interface ApiAuthCodePlaceholder extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Auth placeholder';
    pluralName: 'placeholders';
...
export interface ApiPricingPricing extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    makCardsPrice: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        ...
        number
      > &
      Schema.Attribute.DefaultTo<1890>;
    mediumPrice: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        ...
        number
      > &
      Schema.Attribute.DefaultTo<3990>;
    premiumPrice: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        ...
        number
      > &
      Schema.Attribute.DefaultTo<4990>;
    publishedAt: Schema.Attribute.DateTime;
    sectionPrice: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
        ...
        number
      > &
      Schema.Attribute.DefaultTo<890>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    passwordResetCode: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userMethodSections: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-method-section.user-method-section'
    >;
    username: Schema.Attribute.String &
